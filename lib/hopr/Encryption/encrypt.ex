defmodule Hopr.Encrypt.Encrypt do
  @moduledoc """
  ...
  @block_size 16
  @secret_key "ba94800d-d3f2-4571-b77f-9d8867e66453"
  ...
  """
  @spec decrypt(String) :: String
  def decrypt(plain_text) do
    secret_key_hash = make_hash(@secret_key, 32)
